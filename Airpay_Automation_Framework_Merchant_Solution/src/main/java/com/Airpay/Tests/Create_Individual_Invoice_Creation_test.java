...
public class Create_Individual_Invoice_Creation_test extends Driver_Setup
{
	...
	public void TestCase_Login() throws Throwable
	{
		...
		if(stu_report.approvalStatus()) 
		{
			...
			stu_report.Invoicetabchoice(Student_Report_PageObject.IndividualRadioBtn);
			...
			stu_report.check_user_recordsSample();
