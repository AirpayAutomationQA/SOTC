...
public class TC_001_TanishqPayLogoVerifyThrough_op extends Driver_Setup{
	...
	public void TC_TestCaseName() throws Throwable {
		try {
			...
			CA_panel.InvoiceLogoVerify(Airpay_CAPanel_PageObject.TanishqLogo);
			CA_panel.InvoicePendingViewIcon();
			CA_panel.InvoiceLogoVerify(Airpay_CAPanel_PageObject.TanishqLogo);
			CA_panel.TanishqPendingStatus();
			//CA_panel.InvoiceCrossVerify();
