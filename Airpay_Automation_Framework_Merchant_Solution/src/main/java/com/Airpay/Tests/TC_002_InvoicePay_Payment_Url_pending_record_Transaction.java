...
public class TC_002_InvoicePay_Payment_Url_pending_record_Transaction extends Driver_Setup{
	...
	public void TC_TestCaseName() throws Throwable {
		try {
			...
			CA_panel.InvoicePending();
			CA_panel.InvoiceSinglePendingtransaction();
