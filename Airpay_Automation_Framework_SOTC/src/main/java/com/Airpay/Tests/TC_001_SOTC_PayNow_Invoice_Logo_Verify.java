...
public class TC_001_SOTC_PayNow_Invoice_Logo_Verify extends Driver_Setup{
	...
	public void TC_TestCaseName() throws Throwable {
		try {
			...
			CA_panel.SOTC_Panel_Login();
			CA_panel.Manage_Invoices_payNow();
			CA_panel.Manage_invoicePayNowLink();
			CA_panel.TermsAndCondition();
