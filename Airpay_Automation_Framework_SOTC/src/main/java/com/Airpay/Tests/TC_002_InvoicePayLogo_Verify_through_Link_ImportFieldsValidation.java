...
public class TC_002_InvoicePayLogo_Verify_through_Link_ImportFieldsValidation extends Driver_Setup{
	...
	public void TC_TestCaseName() throws Throwable {
		try {
			...
			CA_panel.InvoiceLogoVerify();
			CA_panel.InvoiceImportBtnVerify();
